...
const configurationConstants = {
	 ...
	 CALENDAR_URL: AIRBNB_PREFIX + '/v2/calendar_days?key={$CLIENT_ID}&currency=USD&locale=en&listing_id={$LISTING_ID}&start_date={$START_DATE}&end_date={$END_DATE}&_format=with_conditions',
	 CLIENT_ID: 'd306zoyjsyarp7ifhu67rjxn52tv0t20', //normally this should be kept in a .gitignored file or loaded with from process.env via dotenv 
